...
export function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/60 dark:border-slate-800 transition-all duration-300">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link
              href="/auth"
              className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-slate-600 hover:text-[#1F4FD8] transition-colors"
            >
            ...
            <Link
              href="/auth"
              className="hidden md:block px-5 py-2.5 bg-slate-900 text-white text-sm font-semibold rounded-full hover:bg-slate-800 hover:shadow-lg hover:shadow-slate-900/20 transition-all active:scale-95"
            >
              Get Started
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden absolute top-full left-0 w-full bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-xl animate-in slide-in-from-top-2">
            <nav className="flex flex-col p-4 gap-2">
              ...
              <Link
                href="/auth"
                className="px-4 py-3 bg-slate-900 text-white font-semibold rounded-lg text-center shadow-lg shadow-slate-900/10 active:scale-95 transition-all"
                onClick={() => setMobileMenuOpen(false)}
              >
                Get Started
              </Link>
